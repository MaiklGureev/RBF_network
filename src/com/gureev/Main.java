...
//        Config 1 bank
//        double[] c1 = new double[]{42, 7, 1, 2, 0, 1, 1, 0, 8, 3, 2, 0, 0}; //0
//        double[] c2 = new double[]{54, 10, 2, 3, 0, 0, 0, 0, 13, 3, 1, 0, 0}; //1
//        double[] c3 = new double[]{48, 9, 2, 3, 0, 1, 1, 0, 11, 3, 2, 0, 0}; //0.5
